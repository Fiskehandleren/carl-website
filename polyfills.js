...
!function() {
  ...
  !function(a2, b2) {
    ...
    function g(a3) {
      return "number" == typeof a3 && (a3 = isNaN(a3) ? {
        duration: 0
      } : {
        duration: a3
      }), a3;
    ...
    !function(a2, b2, c2) {
      ...
      function e(c3) {
        ...
        for (var e2 in c3) for (var f = c3[e2], g = 0; g < f.length - 1; g++) {
          ...
          0 == g && (l = -1 / 0, 0 == k && (i = h)), g == f.length - 2 && (m = 1 / 0, 1 == j && (h = i)), d3.push({
            applyFrom: l,
            applyTo: m,
      ...
      function d2(b3, c3) {
        for (; b3.lengths.length < Math.max(b3.lengths.length, c3.lengths.length); ) b3.lengths.push({
          px: 0
        });
        for (; c3.lengths.length < Math.max(b3.lengths.length, c3.lengths.length); ) c3.lengths.push({
          px: 0
        });
      ...
      function d2(a3, b3) {
        if ("0" == (b3 = b3.trim().toLowerCase()) && "px".search(a3) >= 0) return {
          px: 0
        };
        if (/^[^(]*$|^calc/.test(b3)) {
      ...
      function e(b3) {
        ...
        for (var c3, d3 = /\s*(\w+)\(([^)]*)\)/g, e2 = [], f2 = 0; c3 = d3.exec(b3); ) {
          ...
          if (e2.push({
            t: g2,
            d: k2
          }), d3.lastIndex == b3.length) return e2;
        }
      }
      function f(a3) {
      ...
      function d2(b3, d3) {
        ...
        if (e2 && "" == e2[1]) {
          var f2 = e2[0];
          if (f2[0] = f2[0] || "center", f2[1] = f2[1] || "center", 3 == b3 && (f2[2] = f2[2] || {
            px: 0
          }), f2.length == b3) {
      ...
      function e(d3) {
        ...
        if (e2) {
          for (var f2 = e2[0], h2 = [{
            ...
            var l = f2[k];
            "string" == typeof l ? (j = /bottom|right/.test(l), i2 = {
              left: 0,
              right: 0,
              center: i2,
              top: 1,
              bottom: 1
            }[l], h2[i2] = g[l], "center" == l && i2++) : (j && (l = b2(l), l["%"] = (l["%"] || 0) + 100), h2[i2] = l, i2++, j = false);
          }
          return [h2, e2[1]];
        }
      }
